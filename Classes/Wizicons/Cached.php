...
class tx_wmdbbaseewh_cached_wizicon {
	...
	public function proc($wizardItems)	{
		...
		$wizardItems['plugins_wmdb_base_ewh_cached'] = array(
			...
			'description' => $GLOBALS['LANG']->getLLL('tt_content.CType.cached_description', $LL),
			'params' => '&defVals[tt_content][CType]=wmdb_base_ewh_cached',
			'tt_content_defValues' => array(
				'CType' => 'wmdb_base_ewh_cached',
			),
		);
